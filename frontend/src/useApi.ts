...
type Params<PATH extends Paths, METHOD extends Methods<PATH>> = GetOrProp<api.paths[PATH][METHOD], 'parameters'>
export type Response<PATH extends Paths, METHOD extends Methods<PATH>> = GetOrProp<api.paths[PATH][METHOD], 'responses'>
...
export type Result<PATH extends Paths, METHOD extends Methods<PATH>, STATUS extends "success" | "old"> =
    {
...
function formatQuery<PATH extends Paths, METHOD extends Methods<PATH>>(payload: Payload<PATH, METHOD>) {
    if ('query' in payload) {
...
export function useApi<PATH extends Paths, METHOD extends Methods<PATH> & string>(
    path: PATH,
    method: METHOD,
